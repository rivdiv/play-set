...
<body>
    <div class="mainContainer">
        <div class="header">
            SET<a href="https://github.com/rivdiv/play-set" target="_blank"><img class="forkme"
                src="Images/fork-me-right-white.png" alt="Fork me on GitHub" /></a></div>
        <div class="mainContent">
                ...
                <ContentTemplate>
                    <div class="notifyContainer">
                        <asp:Panel ID="panelNotify" runat="server">
                            <asp:Label ID="lblNotify" runat="server" />&nbsp;<asp:ImageButton ID="btnTweet" runat="server"
                                ToolTip="Tweet this" ImageUrl="~/Images/bird_blue_16.png" Visible="false" />
                        </asp:Panel>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
            <table style="width: 100%">
                        ...
                        <asp:UpdatePanel ID="upControls" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div>
                                    ...
                                    &nbsp;<asp:Button ID="btnPick3More" runat="server" Text="Pick 3 More" OnClick="btnPick3More_Click"
                                        BackColor="Purple" />
                ...
                <tr>
                    <td class="col1" colspan="2" style="height: 30px">
                    </td>
                </tr>
                <tr>
                    <td class="col1">
                                ...
                                <asp:DataList ID="dlCards" runat="server" RepeatColumns="4" OnItemDataBound="dlCards_ItemDataBound"
                                    ...
                                    <ItemTemplate>
                                        <div class="bigCard">
                                            ...
                                            <asp:ImageButton ID="ImageButton1" runat="server" CssClass="roundedCornerBig" Height="130"
                                                Width="130" CommandName="Click" CommandArgument='<%#Eval("CardID") %>' />
                                        </div>
                                    </ItemTemplate>
                                </asp:DataList>
                            </ContentTemplate>
                    ...
                    <td>
                        <asp:UpdatePanel ID="upYourSets" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:DataList ID="dlYourSets" runat="server" RepeatColumns="3" OnItemDataBound="dlYourSets_ItemDataBound"
        ...
        <div class="footer">
            Powered by ASP.NET - @rivdiv 2013</div>
    </div>
</body>
</html>
