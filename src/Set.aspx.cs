...
public partial class Set : System.Web.UI.Page
{
    ...
    protected void btnStop_Click(object sender, EventArgs e)
    {
        ...
        btnTweet.OnClientClick = string.Format("window.open('https://twitter.com/intent/tweet?original_referer=http://playnet.azurewebsites.net/&text=I found {0} SETs in {1} minutes and {2} seconds.&url=http://playnet.azurewebsites.net&via=rivdiv','twitterPopup','width=300,height=300,toolbar=0,menubar=0,location=0');return false;", lblYourSetsCount.Text, d.Minute, d.Second);
